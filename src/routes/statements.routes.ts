...
import { GetTransferOperationController } from '../modules/statements/useCases/getTransferOperation/GetTransferOperationController';
...
const transferOperationController = new GetTransferOperationController();
...
statementRouter.post('/transfer/:user_id', transferOperationController.handle)
