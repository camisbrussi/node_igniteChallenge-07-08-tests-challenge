...
import { IGetTransferOperationDTO } from './IGetTransferOperationDTO';

@injectable()
class GetTransferOperationUseCase {
 constructor(
 ...
 async execute({ user_id, sender_id, description, amount }: IGetTransferOperationDTO): Promise<Statement> {
...
export { GetTransferOperationUseCase }
